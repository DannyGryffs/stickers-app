...
//1. write func
//2. add its params
//3. search for user w matching id
//4.
...
// const startsWithLetterA = (arr) => {
//   // let newArr = arr.filter((element, index, arr) => {
//   //  return element.startsWith('a') && element.starsWith('A')
//   // })
//   // return newArr
// }
...
const formalGreeting = (arr) => {
  let newArr = arr.map((names, index, arr) => {
    return `Hello, ${names}`
  })
  return newArr
}
...
function findProgrammer(empList){
  let newArray = empList.filter((element, index, array) => {
...
// function sortMenuItems(arr){
//   return arr.sort((a, b) => {a.price - b.price});
// }
// return sortMenuItems(exampleMenuItems);
...
const arrProd = numbers.reduce((acc, curr) => {
  return acc * curr
})
  return arrProd
}
